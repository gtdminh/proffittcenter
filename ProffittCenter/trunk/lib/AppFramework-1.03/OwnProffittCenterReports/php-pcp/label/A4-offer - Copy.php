...
<table width="995" height="650" border="0" bgcolor="#ffffff">
  ...
  <tr>
    <td height="720" width="780"  BACKGROUND="../imag/<?php echo "$imag"; ?>.<?php echo "$img"; ?>" STYLE="background-repeat: no-repeat;">
...
<p> <p align="center"><b>
                <span class="style5">        <?php echo "$today"; ?> <BR>  <?php echo "$ShopName"; ?> <?php echo "$enddate"; ?> </span>  &nbsp;</p>
