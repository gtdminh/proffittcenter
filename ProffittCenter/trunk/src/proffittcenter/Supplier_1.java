 ...
 * @author HP_Owner
 */
public class Supplier_1 extends EscapeDialog {

    Preferences root = Preferences.userNodeForPackage(getClass());

    /** Creates new form SupplierN */
    public Supplier_1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("proffittcenterworkingcopy/resource/Supplier"); // NOI18N
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                Supplier_1 dialog = new Supplier_1(new javax.swing.JFrame(), true);
