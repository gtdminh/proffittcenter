 ...
 * @author Dave
 */
public class SettingsTabbed_1 extends EscapeDialog {
...
//    private int shiftFloat = 0;//in pence
    ...
    public SettingsTabbed_1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SettingsTabbed_1 dialog = new SettingsTabbed_1(new javax.swing.JFrame(), true);
