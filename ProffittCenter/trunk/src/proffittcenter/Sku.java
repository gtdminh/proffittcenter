 ...
 * @author HP_Owner
 */
public class Sku extends EscapeDialog {
    ...
    public Sku(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
...
//        }
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        ...
        if (sku > 2) {//do not modify first two
            try {
                ...
                Audio.play("Ring");
                Logger.getLogger(Sku.class.getName()).log(Level.SEVERE, null, ex);
                setVisible(false);
            }
        } else {
            Audio.play("Ring");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                Sku dialog = new Sku(new javax.swing.JFrame(), true);
