...
//            + " AND P.Encoded = " + NewProduct.NOTENCODED
     ...
     * @param modal  
     */
    public StockTake(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        jTable1.setDefaultRenderer(Integer.class, mtcr);
    ...
    private void drawGrid(Integer noOfLines, int sDepartment, int sSku,
        ...
        try {
            ...
            Logger.getLogger(StockTake.class.getName()).log(Level.SEVERE, null, ex);
            Audio.play("Ring");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                StockTake dialog = new StockTake(new javax.swing.JFrame(), true);
