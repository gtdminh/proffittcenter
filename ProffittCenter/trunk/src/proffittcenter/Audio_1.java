 ...
 */
public class Audio_1 extends javax.swing.JFrame {
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == playBtn) {
                Audio_1.this.playBtnActionPerformed(evt);
            }
            else if (evt.getSource() == stopBtn) {
                Audio_1.this.stopBtnActionPerformed(evt);
            }
        }
    ...
    public static void play(String fileName) {
        {
            ...
            try {
                ...
                Logger.getLogger(Audio_1.class.getName()).log(Level.SEVERE, null, ex);
