 ...
 * @author HP_Owner
 */
public class StockByValue extends EscapeDialog {
    ...
    public StockByValue(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                StockByValue dialog = new StockByValue(new javax.swing.JFrame(), true);
