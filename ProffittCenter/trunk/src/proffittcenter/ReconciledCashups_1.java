 ...
 * @author HP_Owner
 */
public class ReconciledCashups_1 extends EscapeDialog {
...
//    private boolean b9 = tableHeader.add(bundle.getString("PaidoutError"));
    ...
    public ReconciledCashups_1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReconciledCashups_1 dialog = new ReconciledCashups_1(new javax.swing.JFrame(), true);
