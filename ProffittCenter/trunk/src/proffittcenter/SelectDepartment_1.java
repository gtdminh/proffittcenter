 ...
 * @author HP_Owner
 */
public class SelectDepartment_1 extends EscapeDialog {
    Preferences root = Preferences.userNodeForPackage(getClass());
    private int department;
    private int returnValue;

    /** Creates new form SelectDepartmentN */
    public SelectDepartment_1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void okBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okBtnActionPerformed
      ...
      int execute() {
        ...
        try {
            ...
            Logger.getLogger(SelectDepartment_1.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SelectDepartment_1 dialog = new SelectDepartment_1(new javax.swing.JFrame(), true);
