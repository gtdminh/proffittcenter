 ...
 * @author Dave
 */
public class RestoreMySQLDatabase_1 extends javax.swing.JFrame {
    private static final long serialVersionUID = 1L;

    /**
     * Creates new form RestoreMySQLDatabase
     */
    public RestoreMySQLDatabase_1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RestoreMySQLDatabase_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        //</editor-fold>
        RestoreMySQLDatabase_1 restoreMySQL = new RestoreMySQLDatabase_1();
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RestoreMySQLDatabase_1().setVisible(true);
            }
        });
    }
