 ...
 * @author HP_Owner
 */
public class LowStock1 extends EscapeDialog {

    Preferences root = Preferences.userNodeForPackage(getClass());
    private Integer minimumValue;

    /** Creates new form LowStock */
    public LowStock1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText(bundle.getString("LowStock1.jLabel1.text")); // NOI18N
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                LowStock1 dialog = new LowStock1(new javax.swing.JFrame(), true);
