 ...
 * @author HP_Owner
 */
public class SelectMonthYear_1 extends EscapeDialog {
     ...
     * @param modal  
     */
    public SelectMonthYear_1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SelectMonthYear_1 dialog = new SelectMonthYear_1(new javax.swing.JFrame(), true);
