...
public class InfiniteProgressPanel extends JComponent implements MouseListener
{
     ...
     * </ul>
     */
    public InfiniteProgressPanel(int width,int height)
    {
        this("", width, height);
    }
     ...
     */
    public InfiniteProgressPanel(String text,int width,int height)
    {
        this(text, 14,width,height);
    }
     ...
     */
    public InfiniteProgressPanel(String text, int barsCount,int width,int height)
    {
        this(text, barsCount, 0.70f,width,height);
    }
     ...
     *               shield (or veil).
     */
    public InfiniteProgressPanel(String text, int barsCount, float shield,int width,int height)
    {
        this(text, barsCount, shield, 15.0f,width,height);
    }
     ...
     *            decrease CPU usage.
     */
    public InfiniteProgressPanel(String text, int barsCount, float shield, float fps,int width,int height)
    {
        this(text, barsCount, shield, fps, 300,width, height);
    }
     ...
     */
    public InfiniteProgressPanel(String text, int barsCount, float shield, float fps, int rampDelay,int width,int height)
    {
        this.text 	   = text;
