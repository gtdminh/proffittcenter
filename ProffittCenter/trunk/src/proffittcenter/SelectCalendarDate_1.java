 ...
 * @author Dave
 */
public class SelectCalendarDate_1 extends EscapeDialog {
    private Calendar date;
    private Calendar returnDate;

    /** Creates new form SelectCaledarDate */
    public SelectCalendarDate_1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                SelectCalendarDate_1 dialog = new SelectCalendarDate_1(new javax.swing.JFrame(), true);
