 ...
 * @author HP_Owner
 */
public class SelectTill extends EscapeDialog {
    ...
    public SelectTill(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                SelectTill dialog = new SelectTill(new javax.swing.JFrame(), true);
