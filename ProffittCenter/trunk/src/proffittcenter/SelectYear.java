 ...
 * @author Dave
 */
public class SelectYear extends EscapeDialog {
    private Calendar theDate;

    /**
     * Creates new form SelectYear
     */
    public SelectYear(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
...
//        theDate.set((Integer)jYear.getValue(), (Integer)jMonth.getValue(), 1);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                SelectYear dialog = new SelectYear(new javax.swing.JFrame(), true);
