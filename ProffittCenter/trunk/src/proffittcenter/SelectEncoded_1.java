 ...
 * @author Dave
 */
public class SelectEncoded_1 extends EscapeDialog {
     ...
     * @param parent
     * @param modal */
    public SelectEncoded_1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SelectEncoded_1 dialog = new SelectEncoded_1(new javax.swing.JFrame(), true);
