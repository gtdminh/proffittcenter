...
public class Sales_1 extends EscapeDialog  {
     ...
     * @param parent
     */
    public Sales_1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private class FormListener implements java.awt.event.ActionListener, java.awt.event.FocusListener, java.awt.event.KeyListener, java.awt.event.MouseListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == closeButton2) {
                Sales_1.this.closeButton2ActionPerformed(evt);
            }
            else if (evt.getSource() == detailsButton) {
                Sales_1.this.detailsButtonActionPerformed(evt);
            }
            else if (evt.getSource() == printButton) {
                Sales_1.this.printButtonActionPerformed(evt);
            }
            else if (evt.getSource() == invoiceButton) {
                Sales_1.this.invoiceButtonActionPerformed(evt);
            }
        }

        public void focusGained(java.awt.event.FocusEvent evt) {
            if (evt.getSource() == jTable1) {
                Sales_1.this.jTable1FocusGained(evt);
            }
        }
        ...
        public void keyReleased(java.awt.event.KeyEvent evt) {
            if (evt.getSource() == jTextField1) {
                Sales_1.this.jTextField1KeyReleased(evt);
            }
        }
        ...
        public void mouseClicked(java.awt.event.MouseEvent evt) {
            if (evt.getSource() == jTable1) {
                Sales_1.this.jTable1MouseClicked(evt);
            }
        }
...
private void drawGrid() {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                Sales_1 dialog = new Sales_1(new javax.swing.JFrame(), true);
