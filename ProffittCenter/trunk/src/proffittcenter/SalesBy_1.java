 ...
 * @author HP_Owner
 */
public class SalesBy_1 extends EscapeDialog {
    ...
    public SalesBy_1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//            okButton.setEnabled(true);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                SalesBy_1 dialog = new SalesBy_1(new javax.swing.JFrame(), true);
