 ...
 * @author HP_Owner
 */
public class Tax_1 extends EscapeDialog {
     ...
     * @param modal
     */
    public Tax_1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//            jRate.setText(StringOps.asPerCent((Integer) rs.getInt("Rate")));
            ...
            Logger.getLogger(Tax_1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//        StringOps.nextComponent(evt, okButton, okButton);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                Tax_1 dialog = new Tax_1(new javax.swing.JFrame(), true);
