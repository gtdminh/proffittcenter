 ...
 * @author HP_Owner
 */
public class StartingStockEntry_1 extends EscapeDialog {
     ...
     * @param modal  
     */
    public StartingStockEntry_1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//                    jTextField1.setText("");
            ...
            Logger.getLogger(StartingStockEntry_1.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                StartingStockEntry_1 dialog = new StartingStockEntry_1(new javax.swing.JFrame(), true);
