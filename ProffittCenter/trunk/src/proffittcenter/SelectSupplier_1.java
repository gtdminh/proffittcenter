...
public class SelectSupplier_1 extends EscapeDialog {
    ...
    int execute() {
        ...
        try {
            ...
            Logger.getLogger(SelectSupplier_1.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SelectSupplier_1 dialog = new SelectSupplier_1(new javax.swing.JFrame(), true);
