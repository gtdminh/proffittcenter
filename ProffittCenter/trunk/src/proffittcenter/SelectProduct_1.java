 ...
 * @author HP_Owner
 */
public class SelectProduct_1 extends EscapeDialog {
    ...
    public SelectProduct_1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("proffittcenterworkingcopy/resource/SelectProduct"); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SelectProduct_1 dialog = new SelectProduct_1(new javax.swing.JFrame(), true);
