 ...
 * @author HP_Owner
 */
public class Takings extends EscapeDialog {
...
//                return nf.format((new Double((Integer) line[14])) / 100);
    ...
    public Takings(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                Takings dialog = new Takings(new javax.swing.JFrame(), true);
...
//                    ,0, 0
            ...
            Logger.getLogger(Takings.class.getName()).log(Level.SEVERE, null, ex);
        }
