 ...
 * @author HP_Owner
 */
public class SelectFloat extends EscapeDialog {

    private Integer floatValue;

    /** Creates new form SelectFloat */
    public SelectFloat(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        AudioPlayer.play("Beep");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                SelectFloat dialog = new SelectFloat(new javax.swing.JFrame(), true);
