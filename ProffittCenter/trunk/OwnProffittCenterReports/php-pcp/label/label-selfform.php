...
<body bgcolor="#000000">
 <div align="left">
  <table border="13" width="254" height="20" bgcolor="#008080" bordercolor="#FFFFFF">
    <tr>
<td width="3" height="40"><form name="form1" method="GET" action="../index.php">
    ...
    <tr>
      <td width="316" height="100">
<form method="POST" action="label-selfform.php" style="color: #0000FF">
<div align="center">
  <center>
<font size="2">OFFER DETAIL(2 for£2) </font>

<input type="text" name="offtex" value="FOR"">
<br>
<font size="2">OFFER other DETAIL(out of dat) </font><br>

<input type="text" name="offtex2" value=""">
<br>
<font size="3">ENTER BARCOD </font><b>

 <input type="text" name="id" size="30">
<input type="submit" value="Submit" style="font-size: 18pt; color: #00FFFF; font-weight: bold"><input type="reset" style="font-size: 14pt; color: #00FFFF; font-weight: bold"></b></pre>
  </center>
</div>
</form>
...
<form id="Form1" method="post" runat="server">
  ...
  <input type="submit" value="Print" style="font-size: 18pt; color: #00FFFF; font-weight: bold" onclick="JavaScript:printPartOfPage('Div1');">
...
<br>
 ...
 <font size="1"> <? echo "$ShopName"?></font> </div></td>
  ...
  <input type="button" value="Print" style="font-size: 18pt; color: #00FFFF; font-weight: bold"  onclick="JavaScript:printPartOfPage('Div1');">
