...
echo '<meta http-equiv=Refresh content="2;url=display-till1.php?reload=1">'; 
...
$query=" SELECT * FROM sales  WHERE TillId=1 ORDER BY WhenCreated DESC LIMIT 1 ";
...
-->
  ...
  <tr>
    <th height="262" bgcolor="#000000" scope="row">&nbsp;</th>
  </tr>
</table>


<table width="965" height="700" border="5" bgcolor="#000000">
  <tr>
    <th width="965" height="422" bgcolor="#0099FF" scope="col"><p><?php echo "$shopname"; ?></p>
      <p></p></th>
  </tr>
  <tr>
    <td height="150"><div  bgcolor="#000000" >
      
                <p align="center"><span class="style1">TOTAL: <?php echo "$total1"; ?> </span><br>
				<P align="center">
				<span class="style2">CASH: <?php echo "$cash1"; ?> </span><br>
	            <p align="center">
                  <span class="style3">CHANGE:<b><?php echo "$change1"; ?> </span> <BR>
                <span class="style4">        <?php echo $shopname?>   ---            <?php echo "$today"; ?> </span>
