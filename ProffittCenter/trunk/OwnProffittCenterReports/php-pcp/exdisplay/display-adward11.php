...
<head>
<meta http-equiv=Refresh content="6;url=display-adward11.php?reload=1">
<style type="text/css">
<!--
.style1 {
	font-size: 60px;
...
$query=" SELECT * FROM products , Offers WHERE Products.id=Offers.Product AND Offers.Product=Products.id ORDER BY RAND()
LIMIT 1";
...
<p id="desc" align="center"><span class="style1"><?php echo "$descr"; ?></span></p>
  ...
  <tr>
    <td height="490" width="450" BACKGROUND="../imag/<?php echo "$imag"; ?>.<?php echo "$img"; ?>">
...
OFFER END DATE :  <?php echo "$enddate"; ?> ID:<?php echo "$ix"; ?></span>
