...
$bar1=mysql_result($result1,$i,"Product");
//--------------

$query2=" SELECT * FROM products , skus WHERE Products.Sku=skus.ID AND skus.Department='$dep'  ";
...
$query=" SELECT * FROM products , Offers WHERE Products.id=Offers.Product AND Products.id='$bar' ORDER BY RAND() LIMIT 1 ";
